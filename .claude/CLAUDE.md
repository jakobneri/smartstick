...
- Music downloads use yt-dlp + ffmpeg (portable, stored in main/music/tools/).
...
- config.txt is gitignored (user-specific).
- main/music/tools/ is gitignored (binaries downloaded by setup).
